...
class TokenFetcher {
  ...
  constructor(requiredOauthScopes) {
    ...
    this.#app.get("/app/redirect", async (req, res) =>
    ...
    this.#server.on("close", () =>
      log.debug("Token handler server is shutting down")
    );
    this.#done = false;
